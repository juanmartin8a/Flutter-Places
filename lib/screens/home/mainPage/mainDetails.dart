...
class MainDetails extends StatefulWidget {
  ...
  final int index;
  final List<DocumentSnapshot> tripsList;
...
class _MainDetailsState extends State<MainDetails> {
  ...
  bool addedPressed = false;
  double animFontSize = 17;

  bool addPressed = false;
  double animFontSize2 = 17;
            ...
            child: Container(
                child: Center(
                    child: PageView.builder(
                        ...
                        onPageChanged: (index) {
                          markerLat = widget.tripsList[index].data()['marker']['geopoint'].latitude;
                          markerLon = widget.tripsList[index].data()['marker']['geopoint'].longitude;
                          headerName = widget.tripsList[index].data()['placeName'];
                          setState(() {
                            currentPage = index;
                            _addMarker();
                            checkIfTripExists();
                                              ...
                                              child: AnimatedContainer(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    ...
                                                    image: DecorationImage(
                                                        image: NetworkImage(widget.tripsList[index].data()['image']),
                                                        fit: BoxFit.cover),
                                                  )),
                                            )),
                                      )
                                          ...
                                          Align(
                                            ...
                                            child: Container(
                                                ...
                                                child: StreamBuilder<DocumentSnapshot>(
                                                    stream: DatabaseService(uid: widget.tripsList[index].data()['uid'])
                                                        .getUserByUid(),
                                          ...
                                          AnimatedContainer(
                                              ...
                                              child: Column(children: [
                                                Container(
                                                    ...
                                                    child: widget.tripsList[index].data()['marker'].isEmpty
                                                        ? Container
                                                        : Text('${widget.tripsList[index].data()['areaName']}',
                                                            style: TextStyle(
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                FractionallySizedBox(
                                                                    ...
                                                                    child: Container(
                                                                      child: FractionallySizedBox(
                                                                          ...
                                                                          child: Container(
                                                                              child: Text(
                                                                                  'days: ${widget.tripsList[index].data()['days']}',
                                                                ...
                                                                FractionallySizedBox(
                                                                  ...
                                                                  child: Container(
                                                                    child: Text(
                                                                        'nights: ${widget.tripsList[index].data()['nights']}',
                                                                        style: TextStyle(
                                                                            color: Colors.grey[700],
                                                                            fontSize: 16,
                                                                            fontWeight: FontWeight.w600)),
                                                                ...
                                                                FractionallySizedBox(
                                                                    ...
                                                                    child: Container(
                                                                        child: Text(
                                                                            '\$${widget.tripsList[index].data()['price']}',
                                                                            style: TextStyle(
                                                                                color: Colors.grey[700],
                                                                                fontSize: 16,
                                                                                fontWeight: FontWeight.w600))))
