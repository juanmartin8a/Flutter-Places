...
import 'package:workingOnUI/services/helper/helperFunctions.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import '../../services/auth.dart';
//import '../../shared/loading.dart';
import 'package:workingOnUI/shared/loader.dart';
            ...
            body: Container(
                ...
                child: Form(
                    ...
                    child: Column(children: <Widget>[
                      ...
                      SizedBox(height: 20),
                      TextFormField(
                        validator: (val) => val.length < 6 ? 'Enter a password longer than 6 numbers' : null,
                        obscureText: true,
                        onChanged: (val) {
                      ...
                      RaisedButton(
                          ...
                          onPressed: () async {
                            if (_formKey.currentState.validate()) {
                              ...
                              dynamic result = await _auth.registerWithEmailAndPassword(email, password).then((user) {
                                ...
                                DatabaseService(uid: user.uid).uploadUserInfo(userMap);
                              });
                              if (result == null) {
